...
const auth = async(req, res) => {
    try {
        ...
        if (user.habilitado) {
            ...
            //mando el id en el jwt,ojo con el id debe ser el mismo dela tabla de BD
            console.log("el id del usuario es :" + user.id_usuario);
            const token = createToken({ id: user.id_usuario }); // sql
